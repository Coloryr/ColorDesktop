...
namespace ColorDesktop.CalendarPlugin.Skin3;

public partial class DayModel : ObservableObject
{
    private static readonly IBrush s_brush1 = Brush.Parse("#e74c3c");
    private static readonly IBrush s_brush2 = Brush.Parse("#c0392b");
    ...
    public DayModel(int year, int month, int day)
    {
        ...
        tip += "\n" + temp.MonthInChinese + LangApi.GetLang("CalendarPluginControl.Text9")
            + temp.DayInChinese;
