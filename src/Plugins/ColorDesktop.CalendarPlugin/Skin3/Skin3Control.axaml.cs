...
public partial class Skin3Control : UserControl
{
    ...
    public Skin3Control()
    {
        ...
        DataContextChanged += Skin3Control_DataContextChanged;
    ...
    private void Skin3Control_DataContextChanged(object? sender, EventArgs e)
    {
